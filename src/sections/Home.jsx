...
export default function Home() {
  const roles = useMemo(() => ["Wed Developer", "MERN Stack Developer"], [])
    ...
    <section
      ...
      <div className="absolute inset-0">
       ...
       bg-linear-to-r from-[#302b63] via-[#00bf8f] to-[#1cd8d2]
        opecity -30 sm:opacity-20 md:opacity-10
        ...
        <div className="relative hidden lg:block">
          ...
          <div
            ...
            style={{
              ...
              background: "conic-gradient(from 0deg , #1cd8d2 , #00bf8f , #302b63)"
            }}
          />

          <motion.img src={avator} alt="Sumit Kumar"
