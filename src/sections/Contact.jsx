...
import { boxEquals, motion } from "framer-motion";
          ...
          <form className="flex flex-col gap-5" onSubmit={handleSubmit}>
            ...
            <div className="flex flex-col">
              ...
              <select name="service"
                ...
                onChange={handleChange}
                className={`p-3 rounded-md bg-white/10 border ${errors.service ? "border-red-500" : "border-gray-500"} text-white focus:outline-none focus:border-gray-500`}
              >
            ...
            {status && (
              <p className={`text-sm ${status === "success" ? "text-green-400" : status === "error" ? "text-red-400" : "text-yellow-400"}`}>
                {status === "sending" ? "sending..." : status === "success" ? "Message sent successfully ✅" : "Something Went Worng ❌"}
              </p>
            )}
